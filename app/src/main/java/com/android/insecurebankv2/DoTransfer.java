...
public class DoTransfer extends Activity {
	...
	public class RequestDoTransferTask extends AsyncTask < String, String, String > {
		...
		protected String doInBackground(String...params) {
			...
			fromText = fromText.replaceAll("<", "& lt;").replaceAll(">", "& gt;");
			fromText = fromText.replaceAll("\\(", "& #40;").replaceAll("\\)", "& #41;");
			fromText = fromText.replaceAll("'", "& #39;");
			fromText = fromText.replaceAll("eval\\((.*)\\)", "");
			fromText = fromText.replaceAll("[\\\"\\\'][\\s]*javascript:(.*)[\\\"\\\']", "\"\"");
			fromText = fromText.replaceAll("script", "");

			toText = toText.replaceAll("<", "& lt;").replaceAll(">", "& gt;");
			toText = toText.replaceAll("\\(", "& #40;").replaceAll("\\)", "& #41;");
			toText = toText.replaceAll("'", "& #39;");
			toText = toText.replaceAll("eval\\((.*)\\)", "");
			toText = toText.replaceAll("[\\\"\\\'][\\s]*javascript:(.*)[\\\"\\\']", "\"\"");
			toText = toText.replaceAll("script", "");


			amount = (EditText) findViewById(R.id.editText_amount);
			nameValuePairs.add(new BasicNameValuePair("from_acc", fromText));
			nameValuePairs.add(new BasicNameValuePair("to_acc", toText));
			...
			final String finalFromText = fromText;
			final String finalToText = toText;
					...
					if (result != null) {
						if (result.indexOf("Success") != -1) {
							...
							try {
								...
								System.out.println("Message:" + jsonObject.getString("message") + " From:" + fromText + " To:" + toText + " Amount:" + amount.getText().toString());
								final String status = new String("\nMessage:" + "Success" + " From:" + fromText + " To:" + toText + " Amount:" + amount.getText().toString() + "\n");
								try {
							...
							System.out.println("Message:" + "Failure" + " From:" + finalFromText + " To:" + finalToText + " Amount:" + amount.getText().toString());
							final String status = new String("\nMessage:" + "Failure" + " From:" + finalFromText + " To:" + finalToText + " Amount:" + amount.getText().toString() + "\n");
